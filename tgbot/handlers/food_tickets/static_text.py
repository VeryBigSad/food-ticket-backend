...
share_qr_code_usage = 'Напиши /share @telegram_username чтобы отдать свой билет на еду сегодня!'
...
you_sure_you_want_to_create_ticket_and_share_it = 'Ты уверен что ты хочешь создать тикет на сегодня на {ft_type} чтобы его получил {first_name} '
you_sure_you_want_to_giveaway_your_ticket = 'Ты уверен чтобы {first_name} стал владельцем твоего талончика на {usable_at_date}, на {ft_type}'
