...
from tgbot.handlers.food_tickets.static_text import (
    confirm_ticket_share,
    decline_ticket_share,
)
...
def start() -> ReplyKeyboardMarkup:
    buttons = [[ReplyKeyboardMarkup("/register"), ReplyKeyboardMarkup("чзх")]]
